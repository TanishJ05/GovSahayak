        ...
        actions: [
          ...
          PopupMenuButton<String>(
            ...
            itemBuilder: (BuildContext context) {
              return [const PopupMenuItem(value: 'clear', child: Text('Clear Chat'))];
            },
          ),
        ],
      ),
          ...
          if (_isTyping)
            Padding(
              ...
              child: Align(
                ...
                child: Row(
                  children: [
                    const SizedBox(width: 15, height: 15, child: CircularProgressIndicator(strokeWidth: 2, color: Color(0xFF1A3C6E))),
