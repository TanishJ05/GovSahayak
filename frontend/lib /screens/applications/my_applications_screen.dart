  ...
  void _showErrorDialog() {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text("We could not find an application with that Tracking ID. Please check the number and try again."),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text("Close"),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          // Refresh button so you can update the list without clearing chat
          IconButton(
      ...
      body: Column(
        children: [
          // NEW: Tracking Search Bar Section
          Container(
            color: Colors.white,
